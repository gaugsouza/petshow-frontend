...
export class PerfilPrestadorComponent implements OnInit {
  servico:ServicoDetalhado = {
    ...
    {id:3, tipoAnimal:{id:3, nome: 'Cachorro', porte: 'Pequeno', pelagem: 'Média'}, preco: 0},
    {id:4, tipoAnimal:{id:4, nome: 'Cachorro', porte: 'Pequeno', pelagem: 'Longa'}, preco: 0},
    {id:5, tipoAnimal:{id:5, nome: 'Cachorro', porte: 'Médio', pelagem: 'Curta'}, preco: 0},
    {id:6, tipoAnimal:{id:6, nome: 'Cachorro', porte: 'Médio', pelagem: 'Média'}, preco: 0},
    {id:7, tipoAnimal:{id:7, nome: 'Cachorro', porte: 'Médio', pelagem: 'Longa'}, preco: 0},
    {id:8, tipoAnimal:{id:8, nome: 'Cachorro', porte: 'Grande', pelagem: 'Curta'}, preco: 0},
    {id:9, tipoAnimal:{id:9, nome: 'Cachorro', porte: 'Grande', pelagem: 'Média'}, preco: 0},
    {id:10, tipoAnimal:{id:10, nome: 'Cachorro', porte: 'Grande', pelagem: 'Longa'}, preco: 0},
  ]
    };
